...
public class SecurityHelper {
     ...
     * @return the {@link SecurityHelper} with the loaded keys
     */
    public static SecurityHelper loadFromKeystore(String keyStorePath, String keyStorePassword, String userAlias) {
        try {
            return new SecurityHelper().loadKeystore(keyStorePath, keyStorePassword, userAlias);
        } catch (Exception e) {
     ...
     */
    public static SecurityHelper loadFromDefaultFiles() {
        ...
        URL privateKeyURL = SecurityHelper.class.getResource("/cert/sdk.key");
        URL x509CertURL = SecurityHelper.class.getResource("/cert/sdk.crt");
     ...
     * @return the SecurityHelper with the loaded private key and certificate
     */
    public static SecurityHelper loadFromFiles(String privateKeyFileName, String x509CertFileName) {
        try {
            return new SecurityHelper().loadPrivateKey(privateKeyFileName).loadX509Cert(x509CertFileName);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    private SecurityHelper loadKeystore(String keyStorePath, String keyStorePassword, String userAlias)
    ...
    private SecurityHelper loadPrivateKey(String privateKeyFileName)
    ...
    private SecurityHelper loadX509Cert(String x509CertFileName) throws IOException, CertificateException {
