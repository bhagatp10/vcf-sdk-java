 ...
 * HCI cluster.
 *
 * <p>Secondly, this sample demonstrates how to get vSAN ESA cluster health status by invoking the
 * QueryClusterHealthSummary API from vSAN health service against VC, then call a vSphere API to configure HCI cluster
 * from vSphere service.
 *
 ...
 * </ol>
 */
public class ConfigureHciWithESASample {
    private static final Logger log = LoggerFactory.getLogger(ConfigureHciWithESASample.class);
    ...
    public static void main(String[] args) throws Exception {
        SampleCommandLineParser.load(ConfigureHciWithESASample.class, args);
        ...
        try (VcenterClient client = clientFactory.createClient(username, password, null)) {
            ...
            vsanConfig.setVsanEsaEnabled(true);
            ...
            monitorTask(hciTask, "Configure HCI with ESA");
    ...
    private static SDDCBase createDefaultVsanSpec() {
        ...
        vsanClusterConfigInfo.setVsanEsaEnabled(true);
