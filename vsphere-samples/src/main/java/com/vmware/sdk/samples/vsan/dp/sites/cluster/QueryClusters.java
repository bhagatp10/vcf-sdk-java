...
package com.vmware.sdk.samples.vsan.dp.sites.cluster;
...
import com.vmware.snapservice.sites.Clusters;
import com.vmware.snapservice.sites.ClustersTypes;
import com.vmware.vapi.protocol.HttpConfiguration;

/**
 * Demonstrates querying clusters for a specific site.
 *
 * <p>Sample Prerequisites: vCenter 9.0.0+
 */
public class QueryClusters {
    private static final Logger log = LoggerFactory.getLogger(QueryClusters.class);
    ...
    /** REQUIRED: Site ID to query clusters for. */
    public static String siteId = "site-id";

    public static void main(String[] args) {
        SampleCommandLineParser.load(QueryClusters.class, args);
    ...
    public static void list(SnapshotServiceClient snapshotServiceClient, String siteId) {
        Clusters clusters = snapshotServiceClient.createStub(Clusters.class);
        log.info("Querying clusters for site: {}", siteId);

        ClustersTypes.ListResult result = clusters.list(siteId, null);
