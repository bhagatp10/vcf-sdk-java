...
public class DeployVcfFleetFirstVcfInstance {
    ...
    /**
     * OPTIONAL: DvsSpec MTU. The value will be set to all dvs specs. If left null the default MTU will be used.
     */
    public static Long dvsMtu = null;
    ...
    public static SddcSpec createSddcSpecForNewVcfFleet(ApiClient vcfClient) throws Exception {
        ...
        builder.setDvsSpecs(SddcSpecHelper.updateMtu(defaultDvsSpecs, dvsMtu));
