...
/**
 * Demonstrates how to deploy new VCF Fleet with first VCF Instance in it, reusing existing Vcenter and using new NSX-T.
 ...
 * </ol>
 *
 * Downloading respective bundles can be achieved by running the {@link DeployVcfFleetFirstFromExistingVcNewNsx} sample.
 */
public class DeployVcfFleetFirstFromExistingVcNewNsx {
    private static final Logger log = LoggerFactory.getLogger(DeployVcfFleetFirstFromExistingVcNewNsx.class);
    ...
    public static void main(String[] args) throws Exception {
        SampleCommandLineParser.load(DeployVcfFleetFirstFromExistingVcNewNsx.class, args);
        ...
        try (ApiClient client =
            ...
            SddcSpec sddcSpec = createSddcSpecForVcfFleetExistingVcNewNsx(client);
    ...
    public static SddcSpec createSddcSpecForVcfFleetExistingVcNewNsx(ApiClient vcfClient) throws Exception {
