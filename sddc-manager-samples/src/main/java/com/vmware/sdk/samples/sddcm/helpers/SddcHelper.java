...
import com.vmware.sdk.samples.sddcm.client.ApiClientHelper;
...
public class SddcHelper {
    ...
    public static class SddcFactory implements AutoCloseable {
        ...
        public SddcFactory(String sddcManagerIpOrFqdn, String sddcManagerSsoUserName, String sddcManagerSsoPassword)
                throws Exception {
            StubConfiguration stubConfiguration = ApiClientHelper.getSddcStubConfiguration(
                    sddcManagerIpOrFqdn, sddcManagerSsoUserName, sddcManagerSsoPassword);
            apiClient = ApiClientHelper.createClient(sddcManagerIpOrFqdn, stubConfiguration);
