 ...
 */
public class UserManagement extends SampleBase {
    ...
    public UserManagement(String clientConfigFile, String sampleConfigClient) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        new UserManagement(args[0], args[1]).run();
    }
}
