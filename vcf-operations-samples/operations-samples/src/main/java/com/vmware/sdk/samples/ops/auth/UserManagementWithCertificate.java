...
import com.vmware.sdk.samples.ops.SampleBaseWithCertificate;
 ...
 */
public class UserManagementWithCertificate extends SampleBaseWithCertificate {

    private static final Logger logger = LoggerFactory.getLogger(UserManagementWithCertificate.class);
    ...
    public UserManagementWithCertificate(String clientConfigFile, String sampleConfigClient) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        new UserManagementWithCertificate(args[0], args[1]).run();
    }
}
